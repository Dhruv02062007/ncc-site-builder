  ...
  return (
    <section className="pt-20 bg-card">
      <div className="container mx-auto px-4 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <FadeIn direction="left" className="flex-1 text-center md:text-left">
            ...
            <p className="text-muted-foreground mt-3 text-lg">[Battalion Details]</p>
      ...
      <FadeIn delay={0.3} className="text-center py-8">
        <RevealLine className="w-16 mx-auto mb-4 bg-foreground/30 h-0.5" delay={0.4} />
        <h2 className="font-heading text-4xl md:text-5xl font-light text-muted-foreground tracking-widest">
          Welcome
        </h2>
      </FadeIn>
    </section>
